...
public class Camera extends OperationButtons {
...
//        setContentView(R.layout.camera);//albums.xml in resource
    ...
    @Override
    protected void setProcessedPicture(Bitmap bitmap) {
    ...
    private void startCamera() {
        ...
        startActivityForResult(intent4, TAKE_PHOTO);//on Activity Result
    }
